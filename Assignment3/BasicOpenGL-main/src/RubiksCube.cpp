...
RubiksCube::RubiksCube() 
    : locks{false, false, false, false, false, false} , Sensitivity(1.0f) , RotationAngle(90) , RotationDirection(1)  , RotationMatrix (glm::mat4(1.0f))  { // Initialize all faces to true
...
glm::vec3 RubiksCube::getPosition(){
    ...
    return this->cubesPosition[1][1][1]->getPosition() ; 
}
